...
return array(
	...
	'sp_core_path' => KXJ_PATH, 
	'sp_drivers_path' => KXJ_PATH, 
	'sp_include_path' => array( KXJ_PATH.'/ext' ),
	...
	'allow_trace_onrelease' => FALSE, 
	'notice_php' => KXJ_PATH."/notice.php", 
	...
	'sp_cache' => KXJ_PATH.'/cache/tmp',
	'sp_session' => KXJ_PATH.'/cache/ses',
	'sp_app_id' => 'sy',
	'controller_path' => APP_PATH.'/source', 
	'model_path' => KXJ_PATH.'/class', 
	...
	'view' => array( 
		...
		'config' =>array(
			...
			'template_tpl' => KXJ_PATH.'/cache/tpl',
		),
		'engine_name' => 'templatedoyo', 
		'engine_path' => KXJ_PATH.'/Template.php', 
	),
